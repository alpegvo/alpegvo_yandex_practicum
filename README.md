...
В репозитории находятся папки с файлами проектов по анализу данных с использованием средств Python и PostgreSQL. Проекты выполнялись в рамках курса "Аналитик Данных" от Яндекс.Практикума.
Python-проекты были выполнены в Jupyter Notebook, а SQL-проекты - на учебной платформе Практикума. 

Порядок, в котором перечислены проекты отражает процесс обучения - от простого к сложному: первые проекты достаточно просты, а последние - более сложные, в них применяется более широкий арсенал средств анализа данных, включая средства продвинутой визуализации и статистики.

**Список SQL-проектов:**
1. **alpegvo_yp/basic_sql** 

**Список python-проектов с названиями папок:**
