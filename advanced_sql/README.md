...
## Описание:
Учебный проект, в котором я выполнила 20 SQL-запросов на формирование выгрузок из базы данных. Основной акцент в задачах сделан на применении **агрегирующих и ранжирующих оконнных функций, а также оконных функций смещения, подзапросов и общих табличных выражений**.
