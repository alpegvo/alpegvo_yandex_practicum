# Продвинутый SQL
Учебный проект, в котором решено 20 задач - 20 SQL-запросов на формирование выгрузок из базы данных PostgreSQL.

Основной акцент в задачах сделан на применении **агрегирующих и ранжирующих оконнных функций, а также оконных функций смещения, подзапросов и общих табличных выражений**.
